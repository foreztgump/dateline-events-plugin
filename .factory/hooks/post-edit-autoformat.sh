...
# Hook: PostToolUse | Matcher: Edit|Create
...
# Extract file path from tool input. Factory uses Create/Edit; we accept any
# tool name whose payload carries .tool_input.file_path.
